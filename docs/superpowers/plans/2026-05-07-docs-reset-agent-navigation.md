...
**Files:**
- Verify: `README.md`, `AGENTS.md`, `CLAUDE.md`, `docs/superpowers/specs/2026-05-07-docs-reset-agent-navigation-design.md`
...
```bash
rg -n "Specs in `docs/superpowers/specs/` are the source of truth|code that disagrees with a spec is a bug|specs are source of truth" README.md AGENTS.md CLAUDE.md
```
