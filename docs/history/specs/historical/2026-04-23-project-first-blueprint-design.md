...
- `docs/history/specs/historical/2026-04-14-mutations-design.md` (derived events from `stateMachine`)
- `docs/history/specs/historical/2026-04-15-ui-layer-design.md` (current per-service UI framing)
