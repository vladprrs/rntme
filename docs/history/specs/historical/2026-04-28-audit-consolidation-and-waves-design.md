...
**Process changes** (e.g. updating the decision tree) are made by editing this spec, with rationale recorded; the previous version moves to `docs/history/specs/historical/`.
