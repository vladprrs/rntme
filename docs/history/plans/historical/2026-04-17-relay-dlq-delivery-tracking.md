...
**Source spec:** `docs/history/specs/historical/2026-04-17-relay-dlq-delivery-tracking-design.md` (A1 scope — minimum viable; follow-ups A2/A3 listed at the end of the spec are explicitly deferred).
