...
**Spec:** `docs/history/specs/historical/2026-04-17-readme-for-coding-agents-design.md`
...
1. The design spec at docs/history/specs/historical/2026-04-17-readme-for-coding-agents-design.md.
...
| `<PKG-SPECIFIC SPEC PATHS>` | `docs/history/specs/historical/2026-04-14-mutations-design.md` (stateMachine, derived event types) | `docs/history/specs/historical/2026-04-14-mutations-design.md` §event store, relay | `docs/history/specs/historical/2026-04-14-bindings-design.md` |
...
docs/history/specs/historical/2026-04-17-readme-for-coding-agents-design.md.
...
| `<PKG-SPECIFIC SPEC PATHS>` | `docs/history/specs/historical/2026-04-14-mutations-design.md` §6, `docs/history/specs/historical/2026-04-16-qsm-relations-migration-design.md` | `docs/history/specs/historical/2026-04-15-runtime-seed-design.md` |
...
| `<PKG-SPECIFIC SPEC PATHS>` | `docs/history/specs/historical/2026-04-13-graph-ir-sql-compiler-mvp-design.md`, `docs/history/specs/historical/2026-04-14-mutations-design.md` (command-runtime), `docs/history/specs/historical/2026-04-16-predicate-optional-fix-design.md`, `docs/history/specs/historical/2026-04-16-qsm-relations-migration-design.md`, `graph_ir_rc_7.md` (root) |
...
| `<PKG-SPECIFIC SPEC PATHS>` | `docs/history/specs/historical/2026-04-14-mutations-design.md` §projection-consumer |
...
| `<PKG>` | `bindings-http` |
| `<SIZE TARGET FROM §3>` | 200–300 lines |
| `<PKG-SPECIFIC SPEC PATHS>` | `docs/history/specs/historical/2026-04-14-bindings-http-design.md` |
| `<RELEVANT MEMORY ENTRIES>` | none |
...
| `<PKG>` | `ui` | `ui-runtime` |
| `<SIZE TARGET FROM §3>` | 250–350 lines | 200–300 lines |
| `<PKG-SPECIFIC SPEC PATHS>` | `docs/history/specs/historical/2026-04-16-ui-artifact-v2-design.md` | `docs/history/specs/historical/2026-04-16-ui-artifact-v2-design.md` |
| `<RELEVANT MEMORY ENTRIES>` | none | none |
...
| `<PKG>` | `runtime` |
| `<SIZE TARGET FROM §3>` | 200–300 lines |
| `<PKG-SPECIFIC SPEC PATHS>` | `docs/history/specs/historical/2026-04-15-runtime-packaging-design.md` (referenced by current README; verify path before passing to subagent), `docs/history/specs/historical/2026-04-15-runtime-seed-design.md` |
...
```bash
ls docs/history/specs/active-rationale/ | grep runtime
```
...
| `<PKG-SPECIFIC SPEC PATHS>` | `docs/history/specs/historical/2026-04-16-demo-issue-tracker-fixes-design.md`, `docs/history/specs/historical/2026-04-16-demo-v2-migration-design.md` |
...
Open `docs/history/specs/historical/2026-04-17-readme-for-coding-agents-design.md` and read §5 in full. The 10 numbered subsections (1. Workflow expectations through 10. Glossary) are the headings. Do not invent new sections; do not skip any.
...
```bash
grep -rln 'SQLite' docs/history/specs/active-rationale/ | head -5  # for "Why SQLite"
grep -rln 'entity-mirror' docs/history/specs/active-rationale/ | head -5  # for "Why entity-mirror only"
grep -rln 'four-layer' docs/history/specs/active-rationale/ | head -5  # for "Why the four-layer validator"
grep -rln 'YAML' docs/history/specs/active-rationale/ docs/adr/ | head -5  # for "Why no YAML"
```
...
docs/history/specs/historical/2026-04-17-readme-for-coding-agents-design.md §5.
