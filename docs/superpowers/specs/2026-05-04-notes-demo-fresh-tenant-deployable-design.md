...
**Related:**
- `docs/superpowers/specs/done/2026-05-03-module-provisioner-contract-design.md` — provisioner contract; required prereq, merged.
- `docs/superpowers/specs/2026-05-03-provisioner-bundle-transport-design.md` — bundle v2 + asset transport for provisioner JS; merged. This spec closes its §15 follow-up "`vars`-vs-provisioner architectural mismatch".
- `docs/superpowers/specs/2026-05-01-provisioned-event-bus-design.md` — provisioned Redpanda compose; merged (PR #111). This spec is independent but compatible.
- `docs/superpowers/specs/2026-05-01-notes-demo-recovery-design.md` — operational recovery (manual `token_endpoint_auth_method` PATCH was its leftover gap; this spec eliminates the manual step).
