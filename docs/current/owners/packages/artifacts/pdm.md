...
- [`../../docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md`](/docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md) — historical umbrella design rationale for the project-first pivot: moves `PDM` to the project level, introduces entity-per-file authoring, and restricts meaningful derived events to service-owned entities rather than field-level ownership.
- [`../../docs/history/specs/historical/2026-04-14-mutations-design.md`](/docs/history/specs/historical/2026-04-14-mutations-design.md) — stateMachine extension, derived event types, and the event-sourcing topology that consumes them.
