...
| L5 | **README "Where to look first" references spec paths that may drift** | README §Where to look first links to `../../docs/history/specs/historical/...` using relative paths. | If specs are moved or renamed, links break. | Consider using absolute repo-root paths or a permalink scheme. |
