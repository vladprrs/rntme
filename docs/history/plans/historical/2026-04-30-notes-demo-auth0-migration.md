...
**Spec:** `docs/history/specs/active-rationale/2026-04-30-notes-demo-auth0-migration-design.md`. Read §1–§15 before starting.
...
- Modify (frontmatter only): `docs/history/specs/active-rationale/2026-04-29-notes-demo-auth0-design.md`
- Modify: `docs/history/plans/historical/2026-04-29-notes-demo-auth0.md` (mark Phase 4 superseded)
...
Cross-reference: `docs/history/specs/active-rationale/2026-04-30-notes-demo-auth0-migration-design.md`.
...
In `docs/history/specs/active-rationale/2026-04-29-notes-demo-auth0-design.md` add a frontmatter line near the top:
...
In `docs/history/plans/historical/2026-04-29-notes-demo-auth0.md` add the same line near the top of Phase 4. Do not delete the historical task bodies.
...
Expected: only matches inside `docs/history/specs/active-rationale/2026-04-29-notes-demo-auth0-design.md`, `docs/history/plans/historical/2026-04-29-notes-demo-auth0.md`, and the new migration spec/plan (historical references). Anywhere else = bug, fix inline before commit.
...
```bash
git add CLAUDE.md AGENTS.md modules/identity/auth0/README.md demo/notes-blueprint/README.md docs/history/specs/active-rationale/2026-04-29-notes-demo-auth0-design.md docs/history/plans/historical/2026-04-29-notes-demo-auth0.md
