...
```bash
head -3 docs/superpowers/specs/done/2026-04-18-rntme-cli-submodule-design.md | grep SUPERSEDED && echo OK
...
```bash
git add docs/superpowers/specs/done docs/superpowers/plans/done
...
## Spec
- `docs/superpowers/specs/2026-04-30-merge-rntme-cli-back-design.md`
...
**Plan complete and saved to `docs/superpowers/plans/2026-04-30-merge-rntme-cli-back.md`.** Two execution options:
