...
**Spec reference:** `docs/superpowers/specs/2026-05-04-notes-demo-fresh-tenant-deployable-design.md` §8.
...
This is PR1 of 4 implementing the design at `docs/superpowers/specs/2026-05-04-notes-demo-fresh-tenant-deployable-design.md`. PR1 unblocks bundle-transport for the demo by aligning the manifest's `provisioner.entry` path. PR2 (boot fragility) and PR3 (pipeline reorder) follow.
