...
**Related spec:** `docs/superpowers/specs/2026-04-14-mutations-design.md` §3 (event envelope), §5 (storage + relay + Kafka topology), §7.7 (package layout).
...
Plan complete and saved to `docs/superpowers/plans/2026-04-14-rntme-event-store.md`. Two execution options:
