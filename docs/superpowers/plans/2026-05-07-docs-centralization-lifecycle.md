...
`docs/superpowers/specs/2026-05-07-docs-centralization-lifecycle-design.md`.
...
`docs/superpowers/plans/2026-05-07-docs-centralization-lifecycle.md` until this
...
- `docs/superpowers/specs/`, `docs/superpowers/plans/` — active design/plan files until Wave 2 moves historical material.
```
...
- Reference: `docs/superpowers/specs/2026-05-07-docs-centralization-lifecycle-design.md`
...
```bash
rg -n "Wave 2|docs/history|retired" docs/README.md AGENTS.md docs/superpowers/specs/2026-05-07-docs-centralization-lifecycle-design.md
```
...
```bash
rg -n "No CI/API-surface guard|No retired document is physically deleted|deletion review" docs/superpowers/specs/2026-05-07-docs-centralization-lifecycle-design.md docs/README.md AGENTS.md
```
