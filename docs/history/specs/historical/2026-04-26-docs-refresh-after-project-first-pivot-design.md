...
Across these PRs, the canonical authoring/versioning/deploy unit shifted from "one service" to **the project blueprint folder** (`docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md` Q1, Q3).
...
| Q7 | New ADR | None. The project-first pivot is already captured in `docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md`. The deployment pipeline is captured in `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md`. AGENTS.md §8 already links to both. |
...
- Pillar 3 ("Deploy surface") — add explicit mention of `@rntme-cli/deploy-core` (target-neutral plan model) + `@rntme-cli/deploy-dokploy` (Dokploy adapter). Cite spec `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md`.
...
Add bullets for:
- `docs/history/specs/historical/2026-04-19-platform-modules-integration-design.md` — modules story.
- `docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md` — already cited; verify.
- `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md` — deploy pipeline.
...
- **§6.16 Deploy a project via Dokploy.**
  1. Read `rntme-cli/packages/deploy-core/README.md`, `rntme-cli/packages/deploy-dokploy/README.md`, and `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md`.
...
New subsections:
- **§4.9 `@rntme/blueprint`** — full subsection in the same shape as the others (entry function, key types, validation pipeline, output → consumed by `@rntme/bindings`/`@rntme/ui`/deploy pipeline). Reference `docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md`.
