...
**Spec:** `docs/history/specs/active-rationale/2026-05-02-publish-path-end-to-end-hardening-design.md` §11 step 9, §12
...
**Create:**
- `docs/history/runbooks/2026-05-02-notes-demo-restoration.md` — operational runbook (the engineer follows this against prod)
...
**Files:**
- Create: `docs/history/runbooks/2026-05-02-notes-demo-restoration.md`
...
8. Record results:
   - Append to `docs/history/specs/historical/` once the spec is moved (or mark in the spec itself that operational restoration completed on 2026-05-02 with deployment id `<id>`).
```

- [ ] **Step 2: Commit the runbook**

```bash
git add docs/history/runbooks/2026-05-02-notes-demo-restoration.md
...
**Files:**
- Modify: `docs/history/specs/active-rationale/2026-05-02-publish-path-end-to-end-hardening-design.md`

- [ ] **Step 1: Move spec to `done/` and add operational outcome**

```bash
mkdir -p docs/history/specs/active-rationale/done
git mv docs/history/specs/active-rationale/2026-05-02-publish-path-end-to-end-hardening-design.md docs/history/specs/historical/
```
...
```bash
test -f docs/history/runbooks/2026-05-02-notes-demo-restoration.md && echo OK
```
