...
**Supersedes (Phase 4 only):** `docs/history/specs/active-rationale/2026-04-29-notes-demo-auth0-design.md` §6 (UI auth-shell)
**Builds on:** `docs/history/specs/active-rationale/2026-04-29-ui-module-contributions-design.md` (RNT-388)
...
**Status update (2026-05-06):** Backend references inherited from the original Auth0 plan that mention binding `pre[]` or Graph IR `$pre` are superseded by `docs/history/specs/historical/2026-05-06-graph-ir-effect-operations-design.md`. The UI-module migration remains the target browser architecture.
