...
**Depends on:** Track 1 (`docs/history/plans/historical/2026-04-26-project-deploy-flow-track-1-upload.md`) — `project_version` table, `ProjectVersionRepo`, the upload route, the project-version UI page. Do not start Track 2 until Track 1 is merged into `main`.
