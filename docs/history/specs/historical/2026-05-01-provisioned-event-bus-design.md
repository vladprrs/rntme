...
**Related:**
- `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md` - project deployment pipeline. This spec changes D13/D14 by adding an explicit provisioned event bus path while preserving external Kafka/Redpanda.
- `docs/history/specs/historical/2026-04-26-project-deploy-flow-design.md` - platform deploy targets and deployment executor.
- `docs/history/specs/active-rationale/2026-04-29-notes-demo-auth0-design.md` - current Redpanda Cloud path. This spec adds a target-local alternative; it does not replace the external Redpanda Cloud option.
