...
export type MembershipStatus = Rntme.contracts.identity.v1.MembershipStatus;
...
export interface Paginated<T> {
  ...
  listMetadata?: { before?: string | null; after?: string | null } | undefined;
  list_metadata?: { before?: string | null; after?: string | null } | undefined;
}
