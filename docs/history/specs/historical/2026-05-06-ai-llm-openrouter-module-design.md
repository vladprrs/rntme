...
**Related:**
- `docs/history/specs/historical/2026-04-26-ai-llm-canonical-contract-design.md` — defines the canonical AI/LLM contract this module implements. This spec lands the first vendor module against that contract and adds non-breaking text/test clarifications.
- `docs/history/specs/active-rationale/2026-04-26-modules-monorepo-structure-design.md` — module pattern, capability declarations, conformance UNION; this spec follows it.
- `docs/history/specs/historical/2026-05-06-graph-ir-effect-operations-design.md` — graph-IR `call` node mechanics that the demo depends on for invoking `AiLlmModule.Complete`.
...
- Implementation plan for this spec — `docs/history/plans/historical/ai-llm-openrouter-module/` (created by writing-plans after this spec is approved).
