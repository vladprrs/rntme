...
**Goal:** Land one new workspace package — `@rntme/contracts-crm-v1` — implementing the protobuf shapes (`crm.proto` + `crm-events.proto`), generated TS bindings, error codes, and README defined by `docs/history/specs/historical/2026-04-27-crm-canonical-contract-design.md`. After this plan, `pnpm -r run build && test && lint && typecheck` passes for the new package and consumers can `import { proto } from '@rntme/contracts-crm-v1'` to access `Contact`, `Company`, `Deal`, `Activity`, `Note`, `AsyncJob`, the `CrmModule` service descriptor, and all twenty-one event payload types.
...
**Spec reference:** `docs/history/specs/historical/2026-04-27-crm-canonical-contract-design.md` §4 (layout), §5 (status enums), §6 (helper messages), §7 (aggregates), §8 (service & request/response), §9 (events), §10 (error codes), §13 (merge order).
...
```json
{
  ...
  "type": "module",
  "private": true,
  "description": "Canonical CRM contract v1 for rntme: Contact, Company, Deal, Activity, Note, AsyncJob; 21 CloudEvents payloads; labeled associations. See docs/history/specs/historical/2026-04-27-crm-canonical-contract-design.md.",
  "exports": {
    ".": {
...
- `docs/history/specs/historical/2026-04-27-crm-canonical-contract-design.md` — design.
...
- `docs/history/specs/historical/2026-04-26-identity-canonical-contract-design.md` — sibling spec; defines `_common/v1/` reused here.
- `docs/history/specs/historical/2026-04-26-ai-llm-canonical-contract-design.md` — sibling spec; introduced AsyncJob pattern reused here.
- `docs/history/plans/historical/crm-canonical-contract/01-crm-contracts.md` — this plan.
- `docs/history/plans/historical/crm-canonical-contract/02-crm-conformance-skeleton.md` — companion plan for conformance package.
```
...
Run a quick mental cross-check against `docs/history/specs/historical/2026-04-27-crm-canonical-contract-design.md`:
