...
**Related:**
- `docs/history/specs/historical/2026-05-03-module-provisioner-contract-design.md` — original provisioner contract; this spec refines its §6 resolver detail and transport.
- `docs/history/specs/historical/2026-05-03-project-update-delete-operations-design.md` — delete-flow tearDown re-uses the same resolver and therefore the same bundle re-materialization.
...
- Cross-reference from this spec into `docs/history/specs/historical/2026-05-03-module-provisioner-contract-design.md`'s §6 ("resolver detail superseded by `2026-05-03-provisioner-bundle-transport-design.md`").
- `docs/history/specs/historical/2026-05-03-project-update-delete-operations-design.md` — add a sentence in §8 noting that delete-flow tearDown re-materializes the bundle.
