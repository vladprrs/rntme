...
- `docs/history/specs/historical/2026-04-19-platform-modules-integration-design.md` — module pattern (wrapper around vendor SDK, gRPC surface, webhook receiver, no choreography). This spec's contract is implemented by AI/LLM wrappers, not gateways.
- `docs/history/specs/historical/2026-04-17-cloudevents-envelope-design.md` — CloudEvents 1.0 envelope; this spec defines the `data` payloads and `type` short-names for the AI/LLM category.
...
- Implementation plans for this spec — `docs/history/plans/historical/ai-llm-canonical-contract/`.
...
This spec decomposes into **2 implementation plans** in `docs/history/plans/historical/ai-llm-canonical-contract/`:
