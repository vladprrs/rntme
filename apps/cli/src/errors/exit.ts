const EXIT_MAP: Record<string, number> = {
  ...
  CLI_DEPLOY_TARGET_FILE_INVALID: 2,
  CLI_DEPLOY_SECRET_MISSING: 2,
  CLI_DEPLOY_BLUEPRINT_INVALID: 2,
  CLI_DEPLOY_PLATFORM_BLUEPRINT_NOT_BUNDLED: 2,
  CLI_DEPLOY_TEARDOWN_FAILED: 10,
  CLI_RESPONSE_PARSE_FAILED: 10,
  CLI_VALIDATE_LOCAL_FAILED: 6,
  CLI_VALIDATE_JSON_INVALID: 6,
  CLI_VALIDATE_NOT_UUID: 6,
