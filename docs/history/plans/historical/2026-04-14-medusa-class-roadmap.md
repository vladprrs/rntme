...
**Spec:** [`docs/history/specs/historical/2026-04-14-medusa-class-roadmap-design.md`](../specs/2026-04-14-medusa-class-roadmap-design.md)
**Companion plan (author intent):** [`docs/history/reports/2026-04-14-medusa-class-roadmap-plan.md`](../reports/2026-04-14-medusa-class-roadmap-plan.md)
...
**Files:**
- Create: `docs/history/reports/2026-04-14-medusa-survey-a-domain-dml.md`
- Create: `docs/history/reports/2026-04-14-medusa-survey-b-module-workflow.md`
- Create: `docs/history/reports/2026-04-14-medusa-survey-c-http-openapi.md`
...
Output: report under 800 words, written to docs/history/reports/2026-04-14-medusa-survey-a-domain-dml.md with H2 per question, code pointers as research/medusa/<path>:<line>. Create the file using Write tool.
```
...
Output: report under 800 words to docs/history/reports/2026-04-14-medusa-survey-b-module-workflow.md with H2 per question, code pointers. Create the file using Write tool.
```
...
Output: report under 800 words to docs/history/reports/2026-04-14-medusa-survey-c-http-openapi.md with H2 per question, code pointers. Create the file using Write tool.
```
...
```bash
ls docs/history/reports/2026-04-14-medusa-survey-*.md
wc -l docs/history/reports/2026-04-14-medusa-survey-*.md
```
...
Read `docs/history/reports/2026-04-14-medusa-survey-a-domain-dml.md`. Write 6–10 bullets with `research/medusa/...` pointers.
...
**Files:**
- Create (gitignored): `docs/history/specs/active-rationale/2026-04-14-commerce-demo-design.md`
...
```bash
f=docs/history/specs/active-rationale/2026-04-14-commerce-demo-design.md
...
- `Links` section has working relative links to all 5 thematic docs AND to `../history/specs/active-rationale/2026-04-14-commerce-demo-design.md`.
...
- [commerce-demo-design.md](../history/specs/active-rationale/2026-04-14-commerce-demo-design.md) (gitignored — local working spec)
```
...
test -f docs/history/specs/active-rationale/2026-04-14-commerce-demo-design.md && echo OK
...
Spec: docs/history/specs/historical/2026-04-14-medusa-class-roadmap-design.md
Plan: docs/history/plans/historical/2026-04-14-medusa-class-roadmap.md"
```
