...
**Related:**
- `docs/history/specs/historical/2026-05-02-cli-remote-deploy-hardening-design.md` - prior CLI remote deploy hardening (PR #112). This spec is the successor; it captures problems still observable after #112 landed and the broken production state of `notes-demo` on 2026-05-02.
...
- `docs/history/specs/historical/2026-04-26-project-deploy-flow-design.md` - platform project versions, deploy targets, deployments, executor, deployment logs.
