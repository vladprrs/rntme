...
**Status update (2026-05-06):** The incident notes below describe the old deployed `pre[]`/`$pre` path. New work must not reintroduce binding-level pre-steps; runtime introspection needed by graph behavior belongs in Graph IR `call` nodes per `docs/history/specs/historical/2026-05-06-graph-ir-effect-operations-design.md`.
**Author:** brainstorm 2026-05-01.
**Related:**
- `docs/history/specs/historical/2026-04-29-notes-demo-auth0-design.md` — landed Auth0 OIDC introspection over gRPC + edge `kind: "auth"` middleware declaration (RNT-364).
- `docs/history/specs/active-rationale/2026-04-30-notes-demo-auth0-migration-design.md` — UI-side auth gating via module `client.boot` (RNT-388).
- `docs/history/plans/historical/2026-05-01-notes-demo-recovery.md` — operational recovery (the deployed bundle is still pre-RNT-388; this spec adds an acceptance step there).
...
`docs/history/plans/historical/2026-05-01-notes-demo-recovery.md` § Task 12 grows two probes:
...
- `docs/history/plans/historical/2026-05-01-notes-demo-recovery.md` — Task 12 acceptance probes.
