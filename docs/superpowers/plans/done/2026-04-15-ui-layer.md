...
**Spec:** `docs/superpowers/specs/2026-04-15-ui-layer-design.md` (read before starting).
...
UI artifact parser + 4-layer validator. See `docs/superpowers/specs/2026-04-15-ui-layer-design.md`.
```
