...
- `docs/superpowers/specs/done/2026-04-26-project-deploy-flow-design.md` - platform project versions, deploy targets, deployments, executor, and deployment logs.
...
- `docs/superpowers/specs/2026-05-01-provisioned-event-bus-design.md` - provisioned Redpanda event bus path.
