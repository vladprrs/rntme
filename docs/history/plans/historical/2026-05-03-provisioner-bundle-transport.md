...
**Spec:** [`docs/history/specs/historical/2026-05-03-provisioner-bundle-transport-design.md`](../specs/2026-05-03-provisioner-bundle-transport-design.md)
...
- Modify: `docs/history/specs/historical/2026-05-03-module-provisioner-contract-design.md` — cross-ref note at §6.
- Modify: `docs/history/specs/historical/2026-05-03-project-update-delete-operations-design.md` — note in §8 about bundle re-materialization.
...
- Modify: `modules/identity/auth0/README.md`
- Modify: `AGENTS.md`
- Modify: `docs/history/specs/historical/2026-05-03-module-provisioner-contract-design.md`
- Modify: `docs/history/specs/historical/2026-05-03-project-update-delete-operations-design.md`
...
In `docs/history/specs/historical/2026-05-03-module-provisioner-contract-design.md`, near §6 (resolver detail), add:
...
In `docs/history/specs/historical/2026-05-03-project-update-delete-operations-design.md`, in §8 (Delete Flow), add a sentence:
...
> deploy provisioning. See `docs/history/specs/historical/2026-05-03-provisioner-bundle-transport-design.md`.
```
...
git add apps/cli/README.md apps/platform-http/README.md \
        ...
        docs/history/specs/historical/2026-05-03-project-update-delete-operations-design.md
