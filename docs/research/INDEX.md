...
| astro + @astrojs/react + @astrojs/mdx | ^5.0.0 / ^4.0.0 / ^4.0.0 | 6.1.10 / 5.0.4 / 5.0.4 | KEEP + UPGRADE (coordinate with React 19 wave) | [astro-plus-astrojs-react-plus-astrojs-mdx/README.md](./astro-plus-astrojs-react-plus-astrojs-mdx/README.md) |
