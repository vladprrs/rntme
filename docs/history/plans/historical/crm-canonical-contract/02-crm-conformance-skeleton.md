...
**Spec reference:** `docs/history/specs/historical/2026-04-27-crm-canonical-contract-design.md` §11 (conformance suite). Modules-monorepo `docs/history/specs/active-rationale/2026-04-26-modules-monorepo-structure-design.md` §7 (conformance suite layout, authorship rule, anti-conformance, capability-coverage report).
...
- `docs/history/specs/historical/2026-04-27-crm-canonical-contract-design.md` §11 — conformance suite design.
...
- `docs/history/plans/historical/crm-canonical-contract/02-crm-conformance-skeleton.md` — this plan.
- `docs/history/plans/historical/crm-canonical-contract/01-crm-contracts.md` — companion plan for contracts package.
```
...
Cross-check against `docs/history/specs/historical/2026-04-27-crm-canonical-contract-design.md`:
