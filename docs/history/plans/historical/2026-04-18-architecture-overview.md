...
**Spec:** `docs/history/specs/historical/2026-04-18-architecture-overview-design.md`.
...
> Status: in progress (writing per plan `docs/history/plans/historical/2026-04-18-architecture-overview.md`).
>
> Spec: `docs/history/specs/historical/2026-04-18-architecture-overview-design.md`.
>
...
```bash
git add docs/architecture.md docs/history/plans/historical/2026-04-18-architecture-overview.md
...
Refs: docs/history/specs/historical/2026-04-18-architecture-overview-design.md"
```
...
- `docs/history/specs/historical/2026-04-18-architecture-overview-design.md` §2 (Primary framing).
...
- `docs/history/specs/historical/2026-04-15-runtime-packaging-design.md`.
- `docs/history/specs/historical/2026-04-15-runtime-seed-design.md`.
...
- Spec lineage: `git log --oneline packages/qsm/` and especially `docs/history/specs/historical/2026-04-16-qsm-relations-migration-design.md`.
...
Cover:
- Relationship to `AGENTS.md` (task-index) and `docs/history/specs/active-rationale/` (decisions).
