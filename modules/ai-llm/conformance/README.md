...
- `docs/superpowers/specs/2026-04-26-ai-llm-canonical-contract-design.md` §12.
- `docs/superpowers/specs/2026-04-26-modules-monorepo-structure-design.md` §7.
- `docs/superpowers/plans/ai-llm-canonical-contract/02-ai-llm-conformance-skeleton.md`.
