...
- **Prerequisite:** Track A (`docs/history/plans/historical/2026-04-23-project-first-blueprint-track-a.md`) is implemented first. This plan assumes `@rntme/blueprint`, `loadBlueprint`, project-level `PDM`, and multi-file service-level `QSM` already exist.
