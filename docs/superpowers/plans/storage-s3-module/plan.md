...
**Spec:** `docs/superpowers/specs/2026-05-06-storage-s3-module-design.md`.
...
```json
{
  ...
  "type": "module",
  "private": true,
  "description": "Canonical Storage contract v1 for rntme: StorageModule service, six file events, STORAGE_<LAYER>_<KIND> error codes. See docs/superpowers/specs/2026-05-06-storage-s3-module-design.md.",
  "exports": {
    ".": {
...
- `docs/superpowers/specs/2026-05-06-storage-s3-module-design.md` — design.
- `docs/superpowers/specs/done/2026-04-26-ai-llm-canonical-contract-design.md` — pattern this contract mirrors.
- `docs/superpowers/specs/done/2026-04-17-cloudevents-envelope-design.md` — envelope shape used by all six events.
```
...
- `docs/superpowers/specs/2026-05-06-storage-s3-module-design.md` — design.
- `docs/superpowers/specs/done/2026-04-26-modules-monorepo-structure-design.md` — module pattern + UNION conformance.
...
- `docs/superpowers/specs/2026-05-06-storage-s3-module-design.md` §12.
```
...
- [ ] **Step 1: Edit each file to add a "See also" line pointing to the spec at `docs/superpowers/specs/2026-05-06-storage-s3-module-design.md`**
