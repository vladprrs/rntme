...
Use whichever local-deploy tooling exists (check `docs/superpowers/specs/done/2026-05-04-deploy-local-cli-design.md` and surrounding plans). Set `OPENROUTER_API_KEY` to a real key for this step.
