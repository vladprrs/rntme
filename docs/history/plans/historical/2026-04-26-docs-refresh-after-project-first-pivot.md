...
**Architecture:** Documentation-only work. No code changes. Each task targets one file (or a small group of related files in the same area). Frequent commits, one per task. The spec at `docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md` is the prescription source — every task cites the spec section it implements and inlines the prescription bullets so the executor does not have to flip back.
...
`docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md`. Tasks reference §6.x sections of the spec by anchor.
...
```bash
ls docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md
```
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.1"
```
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.2.1-§6.2.3"
```
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.2.4"
```
...
- Replace the **"`@rntme/blueprint` currently depends on `@rntme/pdm` and `@rntme/qsm` but is not yet wired into `@rntme/runtime`"** sentence with:
  ...
  - "Project-level runtime intake — boot from a project blueprint folder rather than a single service folder — is **not yet wired** in `@rntme/runtime`. The runtime still boots one service at a time. (See `docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md`.)"
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.2.5-§6.2.6"
```
...
- Cite spec `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md`.
...
Design docs:
- Add bullet `docs/history/specs/historical/2026-04-19-platform-modules-integration-design.md` — modules story.
- Verify bullet `docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md` exists (§224 already references the active version; confirm it's still active or in `done/`).
- Add bullet `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md` — deploy pipeline.
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.2.7-§6.2.9"
```
...
- §8 "The future platform" (deploy section): add a sentence noting that the deploy surface is built on `@rntme-cli/deploy-core` + `@rntme-cli/deploy-dokploy`. Cite spec `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md`.
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.5"
```
...
- "Why deploy via plan→render→apply, not raw CLI?" → `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md`.
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.3"
```
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.4.1"
```
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.4.2-§6.4.3"
```
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.4.4"
```
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.4.5-§6.4.6"
```
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.4.7-§6.4.9"
```
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.6"
```
...
- Spec link: `docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md`.
...
> This demo predates the project-first canonical model (see [`docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md`](../../docs/history/specs/historical/2026-04-23-project-first-blueprint-design.md)).
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.8"
```
...
Spec: \`docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md\`.
...
- Spec link to `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md`.
...
- Skills pack reference (`docs/history/specs/historical/2026-04-19-rntme-skills-pack-design.md`).
...
Parent spec: \`docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md\`.
...
Spec: docs/history/specs/historical/2026-04-26-docs-refresh-after-project-first-pivot-design.md §6.7"
git push
```
