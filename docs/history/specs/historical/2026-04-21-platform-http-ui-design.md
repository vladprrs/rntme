...
**Related:**
- `docs/history/specs/historical/2026-04-19-platform-api-design.md` (control-plane REST surface)
- `docs/history/specs/historical/2026-04-19-platform-modules-integration-design.md` (context for platform-http's role)
- `docs/history/specs/historical/2026-04-20-landing-design.md` (visual restraint baseline)
