...
**Related:**
- `docs/history/specs/historical/2026-04-19-platform-api-design.md` - platform control-plane projects and archival baseline.
- `docs/history/specs/historical/2026-04-24-project-deployment-pipeline-design.md` - deploy-core / deploy-dokploy deployment pipeline.
- `docs/history/specs/historical/2026-04-26-project-deploy-flow-design.md` - platform project versions, deploy targets, deployment executor, and deployment logs.
- `docs/history/specs/historical/2026-05-02-cli-remote-deploy-hardening-design.md` - CLI-triggered remote deployments through platform.
- `docs/history/specs/historical/2026-05-01-provisioned-event-bus-design.md` - provisioned Redpanda resources that delete/teardown must remove.
