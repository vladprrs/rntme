...
**Goal:** Implement the command surface defined in `docs/history/specs/historical/2026-04-19-rntme-cli-platform-commands-design.md` (Scope B: login, token, project, service, version, tag, publish, validate) in the existing `@rntme-cli/cli` package.
...
Read `docs/history/specs/historical/2026-04-19-rntme-cli-platform-commands-design.md` end-to-end. All tasks below reference it by section number.
...
- Design spec: `docs/history/specs/historical/2026-04-19-rntme-cli-platform-commands-design.md`
- Platform API: `docs/history/specs/historical/2026-04-19-platform-api-design.md`
```
