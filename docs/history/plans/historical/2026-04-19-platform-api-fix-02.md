...
**Goal:** Apply the three corrections in `docs/history/specs/historical/2026-04-19-platform-api-errata-02.md` as a single submodule commit (the patch is tight) plus one main-repo commit (submodule pointer bump).

**Spec:** `docs/history/specs/historical/2026-04-19-platform-api-errata-02.md` §1–§3.
