...
**Spec:** `docs/superpowers/specs/2026-05-03-module-provisioner-contract-design.md` (commit `d03b327`).
...
- `docs/superpowers/specs/2026-05-03-project-update-delete-operations-design.md` (D-row + paragraph) **OR** new `…-errata-01.md` if merged before PR 3
...
**Files:**
- Modify: `docs/superpowers/specs/2026-05-03-project-update-delete-operations-design.md` **OR** create `docs/superpowers/specs/2026-05-03-project-update-delete-operations-design-errata-01.md`

- [ ] **Step 23.1: Determine which form to use**

```bash
ls docs/superpowers/specs/done/ | grep '2026-05-03-project-update-delete'
```
...
```bash
git add docs/superpowers/specs/2026-05-03-project-update-delete-operations-design.md
...
5. Record the deployment id, log excerpts, and final state in `docs/superpowers/plans/notes-demo-provisioner-rollout-<date>.md`.
