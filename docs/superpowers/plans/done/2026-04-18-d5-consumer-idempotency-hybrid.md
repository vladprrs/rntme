...
- Move: `docs/superpowers/plans/2026-04-18-d5-consumer-idempotency-hybrid.md` → `docs/superpowers/plans/done/2026-04-18-d5-consumer-idempotency-hybrid.md` (follows existing archive pattern — confirm with `ls docs/superpowers/plans/done/`).
...
Run: `git mv docs/superpowers/plans/2026-04-18-d5-consumer-idempotency-hybrid.md docs/superpowers/plans/done/`

- [ ] **Step 25.5: Commit**

```bash
git add docs/gaps/2026-04-15-event-driven-canonical-audit.md docs/superpowers/plans/
