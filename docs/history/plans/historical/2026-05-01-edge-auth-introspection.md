...
**Spec:** `docs/history/specs/active-rationale/2026-05-01-edge-auth-introspection-design.md`
...
| `docs/history/plans/historical/2026-05-01-notes-demo-recovery.md` | Modify | Task 12 grows two acceptance probes. |
...
**Files:**
- Modify: `docs/history/plans/historical/2026-05-01-notes-demo-recovery.md`
...
```bash
git add docs/history/plans/historical/2026-05-01-notes-demo-recovery.md
...
**Plan complete and saved to `docs/history/plans/historical/2026-05-01-edge-auth-introspection.md`. Two execution options:**
