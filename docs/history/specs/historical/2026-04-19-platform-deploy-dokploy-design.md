...
**Related:**
- `docs/history/specs/historical/2026-04-19-platform-api-design.md` — спроектировал сам сервис (§4.2 external runtime deps — Postgres, rustfs, WorkOS; §4.4 boot order)
- `docs/history/specs/historical/2026-04-18-rntme-cli-submodule-design.md` — механика private submodule'а
...
- `docs/history/specs/historical/2026-04-19-platform-api-design.md` §4 (external deps), §5 (Postgres schema), §14 (boot order)
