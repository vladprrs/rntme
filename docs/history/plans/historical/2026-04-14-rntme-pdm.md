...
**Related spec:** `docs/history/specs/historical/2026-04-14-mutations-design.md` §2, §3, §7.7.
...
See `docs/history/specs/historical/2026-04-14-mutations-design.md` §2-§3 for spec.
```
