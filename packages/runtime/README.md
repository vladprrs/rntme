...
- No `commands: []` / `rows: []` seed sugar — see `docs/superpowers/specs/2026-04-15-runtime-seed-design.md` §1 non-goals.
...
- [`../../docs/superpowers/specs/2026-04-15-runtime-seed-design.md`](../../docs/superpowers/specs/2026-04-15-runtime-seed-design.md) — seed lifecycle, `skipSeed`/`seedMode` config, apply-order guarantees (§3.1, §8.3).
