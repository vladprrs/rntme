...
**Tech Stack:** Node 20+, pnpm 9.12+, TypeScript, `@rntme/blueprint` (validation), `@rntme-cli/cli` (publish), `@rntme-cli/platform-http` (control plane), `@rntme-cli/deploy-core` + `@rntme-cli/deploy-dokploy` (libraries used by executor), Dokploy MCP, Postgres + rustfs (existing на Hetzner).

**Source spec:** `docs/superpowers/specs/2026-04-27-notes-demo-e2e-design.md`.
...
- `rntme-cli` (gitlink) — bump pointer `5d36a09` → `f9712825e414ba009738dbe8f9919fa95fcc67b5`.
...
`docs/superpowers/specs/2026-04-27-notes-demo-e2e-design.md`
```
...
### Task 2.3: Bump submodule rntme-cli
...
Expected: `1 file changed` showing `rntme-cli` gitlink update.
...
docs/superpowers/specs/2026-04-27-notes-demo-e2e-design.md §3.2.
