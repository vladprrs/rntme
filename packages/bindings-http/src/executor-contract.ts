...
export type CommandExecutorInput = Readonly<{
  commandName: string;
...
export type QueryExecutorOk = Readonly<{
  ok: true;
  value: unknown;
}>;

export type QueryExecutorErr = Readonly<{
  ok: false;
  error: QueryExecutorError;
}>;

export type QueryExecutorOutput = QueryExecutorOk | QueryExecutorErr;

export type QueryExecutorInput = Readonly<{
  queryName: string;
  inputs: Record<string, unknown>;
