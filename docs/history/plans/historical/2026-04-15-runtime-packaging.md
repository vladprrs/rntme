...
**Tech Stack:** Node 20, TypeScript, ESM, Hono, better-sqlite3, Vitest, pnpm workspaces. Spec: `docs/history/specs/historical/2026-04-15-runtime-packaging-design.md`.
...
See the design doc `docs/history/specs/historical/2026-04-15-runtime-packaging-design.md` §4.1 for the authoritative schema.
...
**Spec coverage check** (§s refer to `docs/history/specs/historical/2026-04-15-runtime-packaging-design.md`):
...
Plan complete and saved to `docs/history/plans/historical/2026-04-15-runtime-packaging.md`. Two execution options:
