...
**Spec:** `docs/history/specs/active-rationale/2026-05-01-notes-demo-recovery-design.md`
...
| `docs/history/specs/active-rationale/2026-05-01-notes-demo-recovery-design.md` | Already created in brainstorming; included in PR 1. |
...
| File | What changes |
| --- | --- |
| `docs/history/plans/historical/notes-demo-recovery-runbook.md` | Operational record: command outputs, deployment ids, log excerpts, root cause for 502 (whichever branch from spec §7 was hit), final acceptance evidence. |
...
```bash
git add apps/platform-http/README.md docs/history/specs/active-rationale/2026-05-01-notes-demo-recovery-design.md
...
**Files:**
- Create: `docs/history/plans/historical/notes-demo-recovery-runbook.md`
...
cat > docs/history/plans/historical/notes-demo-recovery-runbook.md <<'EOF'
# Notes-demo recovery — runbook

Operational record for the recovery executed against `https://platform.rntme.com`
and `https://dokploy.vladpr.com`. Spec: `docs/history/specs/active-rationale/2026-05-01-notes-demo-recovery-design.md`.
...
**Files:**
- Modify: `docs/history/plans/historical/notes-demo-recovery-runbook.md`
...
```bash
git add docs/history/plans/historical/notes-demo-recovery-runbook.md
...
## Summary
- Operational record for the recovery executed per docs/history/specs/active-rationale/2026-05-01-notes-demo-recovery-design.md.
...
**Plan complete and saved to `docs/history/plans/historical/2026-05-01-notes-demo-recovery.md`. Two execution options:**
