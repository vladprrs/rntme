...
**Status:** design
**Status update (2026-05-06):** References to domain blueprints calling modules through binding-level `pre[]` are historical. The categorical contract goals remain, but domain operation calls are authored as Graph IR `call` nodes per `docs/history/specs/historical/2026-05-06-graph-ir-effect-operations-design.md`.
**Author:** brainstorm 2026-04-26
**Related:**
- `docs/history/specs/historical/2026-04-19-platform-modules-integration-design.md` (three-tier integration model, per-module proto, module skeleton, gRPC surface, pre-fetch, P2 callbacks; this spec sits *on top of* it and adds a categorical contract layer + repo-structure decisions)
- `docs/history/specs/historical/2026-04-17-cloudevents-envelope-design.md` (CloudEvents envelope used by emitted events; `type` namespacing convention used by capability claims)
- `docs/history/specs/historical/2026-04-19-platform-api-design.md` (control-plane registry; the long-term home of contract distribution)
...
- Implementation plans for this spec — `docs/history/plans/historical/modules-monorepo-structure/`
...
This spec decomposes into **3 implementation plans** in `docs/history/plans/historical/modules-monorepo-structure/`:
...
- `docs/history/specs/historical/2026-04-19-platform-modules-integration-design.md` — three-tier integration model, gRPC surface, pre-fetch, P2 callbacks; this spec extends §5 (module pattern) and §12 (module contract).
- `docs/history/specs/historical/2026-04-17-cloudevents-envelope-design.md` — envelope used by emitted events; capability event-names align with envelope `type` short-form.
- `docs/history/specs/historical/2026-04-19-platform-api-design.md` — control-plane registry, long-term home of contract distribution.
