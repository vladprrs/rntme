...
- `docs/superpowers/specs/done/2026-04-26-docs-refresh-after-project-first-pivot-design.md` — cost evidence for letting docs drift
- `docs/superpowers/specs/2026-05-03-module-provisioner-contract-design.md` — provisioner contract design (consumed types, now to be relocated)
