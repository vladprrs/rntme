...
**Spec:** `docs/history/specs/active-rationale/2026-04-29-ui-module-contributions-design.md`. Read §1–§15 before starting.
...
See `docs/history/specs/active-rationale/2026-04-29-ui-module-contributions-design.md` for the full model and `modules/presentation/md-mermaid/`, `modules/presentation/tiptap/`, `modules/analytics/google-analytics/` for reference implementations.
```
...
- `docs/history/specs/active-rationale/2026-04-29-ui-module-contributions-design.md` §3.4 (canonical "MD/Mermaid" example) and §10 (bundle pipeline).
```
...
Plan complete and saved to `docs/history/plans/historical/2026-04-29-ui-module-contributions.md`.
