...
> Why retained: Completed implementation handoff for Redpanda Console manual validation access; implementation landed via PR #167 and current truth is code/tests plus current owner docs.
