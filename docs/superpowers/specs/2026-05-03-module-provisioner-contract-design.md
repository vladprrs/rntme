...
**Related:**
- `docs/superpowers/specs/done/2026-04-23-project-first-blueprint-design.md` — module discovery and `project.json#modules` composition.
- `docs/superpowers/specs/done/2026-04-24-project-deployment-pipeline-design.md` — `deploy-core` / `deploy-dokploy` plan/render/apply pipeline.
- `docs/superpowers/specs/done/2026-04-26-project-deploy-flow-design.md` — platform deployment executor, deploy targets, deployment logs.
- `docs/superpowers/specs/done/2026-04-26-identity-canonical-contract-design.md` — Identity contract (RPC list including `CreateOrganization`).
- `docs/superpowers/specs/done/2026-04-29-notes-demo-auth0-design.md` — current Auth0 module shape (introspection sidecar, client/boot, manifest).
- `docs/superpowers/specs/2026-05-03-project-update-delete-operations-design.md` — project decommission flow (in user-review). This spec adds a per-module tearDown hook *before* its Dokploy resource delete pass.
...
| `docs/superpowers/specs/2026-05-03-project-update-delete-operations-design.md` (or its errata)             | Tear-down hook described in §9                                                                                                                                                                  |
...
- Record outcome in `docs/superpowers/plans/notes-demo-provisioner-rollout-<date>.md`.
