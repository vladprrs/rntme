...
`docs/history/specs/historical/`, per-package READMEs, ADRs, and gap reports.
...
1. **Active specs** — `docs/history/specs/active-rationale/` (current work).
2. **Landed specs** — `docs/history/specs/historical/` (historical but
...
5. **ADRs** — `docs/adr/`.
6. **Gap reports** — `docs/gaps/`, `docs/history/reports/`.
