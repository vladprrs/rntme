...
**Spec reference:** `docs/superpowers/specs/2026-05-04-notes-demo-fresh-tenant-deployable-design.md` §6.
...
PR2 of 4 implementing `docs/superpowers/specs/2026-05-04-notes-demo-fresh-tenant-deployable-design.md`. Independent of PR1 and PR3 — can land in any order.
