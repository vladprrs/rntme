...
- `docs/superpowers/specs/done/2026-04-24-project-deployment-pipeline-design.md` - project deployment pipeline. This spec fills the prior Operaton/BPMN out-of-scope item.
- `docs/superpowers/specs/done/2026-05-01-provisioned-event-bus-design.md` - provisioned Redpanda. The BPMN demo requires a provisioned event bus.
- `docs/superpowers/specs/done/2026-04-19-platform-modules-integration-design.md` - gRPC command surfaces and the no-choreography boundary.
