...
**Companion plan:** [`docs/superpowers/reports/2026-04-14-medusa-class-roadmap-plan.md`](../reports/2026-04-14-medusa-class-roadmap-plan.md) — describes the *steps & schedule* to produce deliverables. This spec describes *how each deliverable is structured internally*.
...
| 7 | `docs/superpowers/specs/2026-04-14-commerce-demo-design.md` | no (gitignored, working spec) |
...
- `docs/superpowers/specs/2026-04-14-commerce-demo-design.md` exists (gitignored is fine).
