...
- [`../../../../docs/superpowers/specs/done/2026-05-04-platform-contracts-extraction-design.md`](../../../../docs/superpowers/specs/done/2026-05-04-platform-contracts-extraction-design.md) — platform contracts extraction, including the `client-runtime/v1` split from `@rntme/ui-runtime`.
